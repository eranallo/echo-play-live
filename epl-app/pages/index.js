  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0a0a0f', display:'flex', flexDirection:'column', alignItems:'center', padding:'2.5rem 1.5rem 2rem' }}>
      ...
      <div style={{ width:'100%', maxWidth:420 }}>
        <button onClick={onCalendar} style={{ width:'100%', padding:'16px', background:'#1a1a2e', border:'1px solid #2a4a2a', borderRadius:10, cursor:'pointer', fontFamily:'inherit', textAlign:'center', marginBottom:12, display:'flex', alignItems:'center', justifyContent:'center', gap:12 }}>
          <span style={{ fontSize:22 }}>📅</span>
          <div style={{ textAlign:'left' }}>
            <div style={{ fontSize:15, fontWeight:700, color:'#a78bfa' }}>Show Availability Calendar</div>
        ...
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10 }}>
          {members.map(m => {
            ...
            return (
              <button key={m.id} onClick={() => onSelect(m)} style={{ display:'flex', flexDirection:'column', alignItems:'center', gap:8, padding:'16px 12px', background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, cursor:'pointer', fontFamily:'inherit', textAlign:'center' }}>
        ...
        <button onClick={onCrew} style={{ width:'100%', padding:'14px', background:'transparent', border:'0.5px solid #1a2a2e', borderRadius:10, cursor:'pointer', fontFamily:'inherit', textAlign:'center' }}>
          <div style={{ fontSize:13, fontWeight:600, color:'#a78bfa' }}>Not a band member?</div>
          <div style={{ fontSize:11, color:'#6b7280', marginTop:3 }}>Sound engineers & merch crew →</div>
        </button>
        <button onClick={onBuilder} style={{ width:'100%', padding:'14px', background:'transparent', border:'0.5px solid #2a1a2e', borderRadius:10, cursor:'pointer', fontFamily:'inherit', textAlign:'center' }}>
...
function QuickCard({ label, value, sub, onClick, color, icon }) {
  return (
    <div onClick={onClick} style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, padding:'14px 16px', cursor:'pointer', display:'flex', flexDirection:'column', gap:6 }}>
...
function NextShowCard({ show, resolve, resolveField, onClick }) {
  ...
  return (
    <div onClick={onClick} style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, overflow:'hidden', cursor:'pointer' }}>
      {venuePhoto ? (
        <div style={{ position:'relative', height:140 }}>
          ...
          <div style={{ position:'absolute', top:10, right:12, background:'#1a1a2e', borderRadius:10, padding:'5px 12px', textAlign:'center' }}>
          ...
          <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:14 }}>
            <div>
              ...
              <div style={{ display:'flex', gap:4, flexWrap:'wrap', alignItems:'center' }}>
                ...
                {f['Indoor / Outdoor'] && <span style={{ fontSize:10, padding:'1px 7px', borderRadius:20, background:'#0a0a0f', color:'#6b7280', border:'0.5px solid #2a2a3a' }}>{f['Indoor / Outdoor'] === 'Outdoor' ? '🌿 Outdoor' : f['Indoor / Outdoor'] === 'Both' ? '🏟️ Both' : '🏠 Indoor'}</span>}
              </div>
            </div>
...
function TimeBlock({ label, value }) {
  return (
    <div style={{ background:'#0a0a0f', borderRadius:8, padding:'8px 10px', textAlign:'center' }}>
...
function ShowRow({ show, resolve, resolveField, onClick }) {
  ...
  return (
    <div onClick={onClick} style={{ display:'flex', alignItems:'center', gap:14, padding:'13px 0', borderBottom:'0.5px solid #1e1e2e', cursor:'pointer' }}>
    ...
    <div style={{ minHeight:'100vh', background:'#0a0a0f', color:'#ffffff', fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif' }}>
      ...
      {(() => {
        ...
        return venuePhoto ? (
          ...
          <div style={{ background:'#0a0a0f', borderBottom:'0.5px solid #1e1e2e', padding:'12px 20px', display:'flex', alignItems:'center', gap:14, position:'sticky', top:0, zIndex:50 }}>
      ...
      <div style={{ padding:'20px 20px 80px' }}>
        ...
        <div style={{ display:'flex', gap:10, marginBottom:20, flexWrap:'wrap' }}>
          {f['Indoor / Outdoor'] && (
            <div style={{ display:'flex', alignItems:'center', gap:6, padding:'8px 14px', background:'#0a0a0f', borderRadius:20, border:'0.5px solid #2a2a3a' }}>
          ...
          {weather && weather !== 'unavailable' && weather !== 'tooFar' && weather !== 'past' && (
            <a
              ...
              style={{ display:'flex', alignItems:'center', gap:8, padding:'8px 14px', background:'#0a0a0f', borderRadius:20, border:`0.5px solid ${weather.rain > 50 ? '#3a2020' : '#2a2a3a'}`, flex:1, textDecoration:'none' }}
            >
              <div style={{ flex:1 }}>
          ...
          {weather === 'tooFar' && (
            <div style={{ display:'flex', alignItems:'center', gap:6, padding:'8px 14px', background:'#0a0a0f', borderRadius:20, border:'0.5px solid #2a2a3a', flex:1 }}>
              ...
              {address && (
                <div style={{ display:'flex', gap:10 }}>
                  ...
                  <button onClick={() => window.open(`https://maps.google.com/?q=${encodeURIComponent(address)}`)} style={{ flex:1, padding:'10px', background:'#1a2e1a', border:'none', borderRadius:10, cursor:'pointer', fontFamily:'inherit', display:'flex', alignItems:'center', justifyContent:'center', gap:7 }}>
                    ...
                    <span style={{ color:'#a78bfa', fontSize:13, fontWeight:600 }}>Google Maps</span>
                  </button>
                </div>
              )}
              {!address && (
        ...
        <div style={{ marginBottom:20 }}>
          ...
          {songRecs.length > 0 ? (
            <div onClick={() => onSetlist({ setlist, songRecs, show })} style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, padding:'16px', cursor:'pointer', display:'flex', alignItems:'center', justifyContent:'space-between' }}>
              <div>
            ...
            <div style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, padding:20, textAlign:'center', color:'#6b7280', fontSize:13 }}>
        ...
        {f['Show Notes'] && (
          <div style={{ marginBottom:20 }}>
            ...
            <div style={{ background:'#1a1a0a', border:'0.5px solid #2a2a1a', borderRadius:10, padding:16, fontSize:13, color:'#e5e5b0', lineHeight:1.6 }}>{f['Show Notes']}</div>
          </div>
        )}
        ...
        {(() => {
          ...
          return (
            <div style={{ marginBottom:20 }}>
              ...
              <div style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, overflow:'hidden' }}>
                {memberRecs.map((m, i) => {
                  const mf = m.fields
                ...
                <div key={label} style={{ padding:'12px 16px', borderBottom: i < rows.length-1 ? '0.5px solid #1a1a2a' : 'none' }}>
                  <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start' }}>
                    <div>
                      ...
                      <div style={{ fontSize:14, fontWeight:600, color:'#ffffff' }}>{name}</div>
                      {role && name !== 'Venue provided' && <div style={{ fontSize:11, color:'#a78bfa', marginTop:2 }}>{role}</div>}
                    </div>
                  </div>
      ...
      <div style={{ background:'#0a0a0f', padding:'12px 20px 10px', borderBottom:'0.5px solid #1e1e2e', position:'sticky', top:52, zIndex:40 }}>
        <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr 1fr', gap:8 }}>
          <button onClick={() => toggleFilter('booked')} style={{ background: filter==='booked' ? '#1a3a1a' : '#0f1f0f', border: filter==='booked' ? '1.5px solid #6bcb77' : '0.5px solid #2a4a2a', borderRadius:10, padding:'10px 12px', textAlign:'center', cursor:'pointer', fontFamily:'inherit' }}>
            <div style={{ fontSize:18, fontWeight:700, color:'#a78bfa' }}>{bookedCount}</div>
                ...
                <div key={ds} style={{ marginBottom:6 }}>
                  <div onClick={() => {
                    ...
                    <div style={{ flex:1, minWidth:0 }}>
                      {isBookedWithConflict ? (() => {
                        ...
                        <div>
                          <div style={{ fontSize:13, fontWeight:600, color:'#a78bfa' }}>{shows.length} shows — tap to select</div>
                        ...
                        <div style={{ fontSize:13, color:'#6b7280' }}>Open — available to book</div>
                      )}
                    </div>
                  ...
                  {isExpanded && isBooked && shows.length > 1 && (
                    <div style={{ background:'#1a1a2e', border:'1px solid #2a4a2a', borderTop:'none', borderRadius:'0 0 10px 10px', padding:'8px 12px', marginBottom:6 }}>
                      <div style={{ fontSize:11, fontWeight:600, color:'#a78bfa', textTransform:'uppercase', letterSpacing:'0.06em', marginBottom:8 }}>Select a show</div>
                      {shows.map((s, i) => {
                        const sf = s.fields
                        const sBands = resolveField(sf['Band'], 'BANDS', 'Band Name')
                        const sVenue = resolve(sf['Venue'], 'VENUES')
            ...
            {pendingDates.length > 0 && (
              <div>
                ...
                {pendingDates.map((p, i) => (
                  <div key={i} style={{ display:'flex', alignItems:'center', justifyContent:'space-between', padding:'8px 12px', background:'#0a0a0f', borderRadius:8, marginBottom:6 }}>
                    <div>
                ...
                <button onClick={submitAll} disabled={submitting} style={{ width:'100%', padding:'13px', background:'#1a1a2e', border:'none', borderRadius:10, color:'#a78bfa', fontSize:14, fontWeight:700, cursor:'pointer', fontFamily:'inherit', marginTop:6 }}>
        ...
        {allShows.length > 0 && (
          <div>
            ...
            {(showAllShows ? allShows : allShows.slice(0, 5)).map(s => {
              ...
              return (
                <div key={s.id} onClick={() => onShowClick(s)} style={{ display:'flex', alignItems:'center', gap:14, padding:'13px 0', borderBottom:'0.5px solid #1e1e2e', cursor:'pointer' }}>
                  <div style={{ width:44, textAlign:'center', flexShrink:0 }}>
                    <div style={{ fontSize:14, fontWeight:700, color:'#a78bfa' }}>{days}</div>
                    <div style={{ fontSize:10, color:'#6b7280' }}>days</div>
                  </div>
                  <div style={{ flex:1, minWidth:0 }}>
...
function CrewBlackouts({ data, crew, onBack }) {
  const f = crew.fields
  const name = f['Name'] || '—'
  const [showForm, setShowForm] = useState(false)
  const [currentDate, setCurrentDate] = useState('')
    ...
    <div style={{ minHeight:'100vh', background:'#0a0a0f', color:'#ffffff', fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif' }}>
      ...
      <div style={{ padding:'8px 20px 80px' }}>
            ...
            {pendingDates.length > 0 && (
              <div style={{ marginTop:14, paddingTop:14, borderTop:'0.5px solid #1a1a2a' }}>
                ...
                <button onClick={submitAll} disabled={submitting}
                  style={{ width:'100%', marginTop:14, padding:'13px', background:'#a78bfa', border:'none', borderRadius:10, color:'#0a0a0f', fontSize:14, fontWeight:700, cursor:'pointer', fontFamily:'inherit' }}>
        ...
        {myBlackouts.length > 0 ? (
          ...
          <div style={{ textAlign:'center', color:'rgba(255,255,255,0.35)', fontSize:14, paddingTop:'2rem' }}>
...
function CrewShowCard({ show, crew, resolve, resolveField, soundShows, merchShows, onClick }) {
  ...
  return (
    <div onClick={onClick} style={{ background:'#0a0a0f', border:'0.5px solid #1a2a2e', borderRadius:10, padding:20, cursor:'pointer' }}>
      <div style={{ display:'flex', justifyContent:'space-between', alignItems:'flex-start', marginBottom:14 }}>
        <div>
          <div style={{ fontSize:18, fontWeight:700, marginBottom:6 }}>{vf['Venue Name'] || '—'}</div>
          <div style={{ display:'flex', gap:4, flexWrap:'wrap' }}>
            {bands.map((b,i) => <BandTag key={i} name={b} />)}
            {isSound && <span style={{ fontSize:10, padding:'2px 8px', borderRadius:20, background:'#1a1a2e', color:'#a78bfa', fontWeight:600 }}>Your role: Sound</span>}
  ...
  return (
    <div style={{ minHeight:'100vh', background:'#0a0a0f', color:'#ffffff', fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif' }}>
      ...
      <div style={{ padding:'16px 20px 80px' }}>
        {notes && (
          <div style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:10, padding:'12px 16px', marginBottom:16 }}>
            <div style={{ fontSize:11, fontWeight:600, color:'#6b7280', textTransform:'uppercase', letterSpacing:'0.08em', marginBottom:6 }}>Set notes</div>
            ...
            return (
              <div key={song.id} style={{ padding:'14px 16px', borderBottom: i < songRecs.length-1 ? '0.5px solid #1a1a2a' : 'none' }}>
                <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:10 }}>
                  <div style={{ width:26, textAlign:'center', flexShrink:0, fontSize:13, fontWeight:700, color:'#3a3a4a' }}>{i+1}</div>
                  <div style={{ flex:1, minWidth:0 }}>
                  ...
                  <div style={{ textAlign:'right', flexShrink:0, display:'flex', flexDirection:'column', gap:4 }}>
                    {(s['Guitar Tuning'] || s['Bass Tuning']) && (
                      <div onClick={e => { e.stopPropagation(); setTuningPopup({ title: s['Song Title'], guitar: s['Guitar Tuning'], bass: s['Bass Tuning'] }) }} style={{ textAlign:'center', cursor:'pointer', padding:'4px 8px', borderRadius:8, background:'rgba(167,139,250,0.08)' }}>
                        <div style={{ fontSize:9, color:'#3a3a4a', textTransform:'uppercase', letterSpacing:'0.04em', marginBottom:2 }}>Tuning</div>
                ...
                <div style={{ display:'flex', gap:8, paddingLeft:38, flexWrap:'wrap' }}>
                  <a href={`https://open.spotify.com/search/${encodeURIComponent((s['Song Title'] || '') + ' ' + (s['Artist'] || ''))}`} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} style={{ display:'flex', alignItems:'center', gap:5, padding:'5px 10px', background:'#1a1a2e', border:'1px solid rgba(245,197,24,0.2)', borderRadius:20, textDecoration:'none' }}>
                  ...
                  <a href={`https://www.ultimate-guitar.com/search.php?search_type=title&value=${encodeURIComponent(s['Song Title'] || '')}`} target="_blank" rel="noopener noreferrer" onClick={e => e.stopPropagation()} style={{ display:'flex', alignItems:'center', gap:5, padding:'5px 10px', background:'#1a1a2e', border:'1px solid rgba(245,197,24,0.2)', borderRadius:20, textDecoration:'none' }}>
      ...
      {tuningPopup && (
        <div onClick={() => setTuningPopup(null)} style={{ position:'fixed', inset:0, background:'rgba(0,0,0,0.75)', zIndex:100, display:'flex', alignItems:'center', justifyContent:'center', padding:24 }}>
          <div onClick={e => e.stopPropagation()} style={{ background:'#0a0a0f', border:'0.5px solid #2a2a3a', borderRadius:20, padding:24, width:'100%', maxWidth:320 }}>
            ...
            <button onClick={() => setTuningPopup(null)} style={{ width:'100%', padding:'12px', background:'#1a1a2e', border:'none', borderRadius:10, color:'#a78bfa', fontSize:14, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>Close</button>
          </div>
        </div>
      )}
    </div>
      ...
      <div style={{ minHeight:'100vh', background:'#0a0a0f', display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', padding:24, fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif' }}>
        ...
        <div style={{ width:'100%', maxWidth:300 }}>
          <input type="password" placeholder="Enter passcode" value={pass}
            ...
            style={{ width:'100%', padding:'14px 16px', background:'#0a0a0f', border: passErr ? '1px solid #ff4444' : '0.5px solid #2a2a3a', borderRadius:10, color:'#ffffff', fontSize:16, fontFamily:'inherit', boxSizing:'border-box', marginBottom:10, outline:'none' }} />
          ...
          <button onClick={() => pass === BUILDER_PASSWORD ? setAuthed(true) : setPassErr(true)}
            style={{ width:'100%', padding:'14px', background:'#c084fc', border:'none', borderRadius:10, color:'#0a0a0f', fontSize:15, fontWeight:700, cursor:'pointer', fontFamily:'inherit' }}>
            Enter
          </button>
...
function SetlistBuilderMain({ data, onBack }) {
  ...
  const [tuningBlockText, setTuningBlockText] = useState('')
    ...
    if (sf['Notes'] && sf['Notes'].startsWith('%%BUILDER%%')) {
      try {
        ...
        builderItems = bd.map(b => {
          if (b.type === 'song') { const s = songs.find(x => x.id === b.id); return s ? {type:'song',id:s.id,fields:s.fields} : null }
  ...
  function emailSetlist() {
    const bRec = bands.find(b => b.id === selectedBand)
    const bName = bRec?.fields['Band Name'] || ''
    const sRec = shows.find(s => s.id === selectedShow)
    const vRec = sRec ? (data['VENUES']||[]).find(v => (sRec.fields['Venue']||[]).includes(v.id)) : null
    const vName = vRec?.fields['Venue Name'] || ''
    const sDate = sRec?.fields['Date'] || ''
    ...
    let num = 1
    items.forEach(item => {
      if (item.type === 'song') { body += num + '. ' + item.fields['Song Title'] + (item.fields['Artist'] ? ' — ' + item.fields['Artist'] : '') + '\n'; num++ }
      else { const map = { break:'\n--- BREAK ---\n', tuning:'\n[ '+item.text+' TUNING ]\n', merch:'\n[ MERCH TABLE ]\n', instagram:'\n[ INSTAGRAM CALLOUT ]\n', custom:'\n[ '+item.text+' ]\n' }; body += map[item.type] || '\n[ '+item.type.toUpperCase()+' ]\n' }
    })
    body += '\n' + items.filter(i=>i.type==='song').length + ' songs · ' + totalDisplay
    if (typeof window !== 'undefined') window.location.href = 'mailto:?subject=' + encodeURIComponent(subject) + '&body=' + encodeURIComponent(body)
  }
  ...
  if (screen === 'home') return (
    <div key={animKey} style={{ minHeight:'100vh', background:'#0a0a0f', color:'#fff', fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif', ...slideStyle }}>
      ...
      <div style={{ background:'#0a0a0f', borderBottom:'0.5px solid #1e1e2e', padding:'12px 20px', display:'flex', alignItems:'center', gap:10, position:'sticky', top:0, zIndex:50 }}>
        ...
        <div style={{ flex:1, fontSize:15, fontWeight:700 }}>Setlist Builder</div>
      </div>

      <div style={{ padding:'32px 20px 40px' }}>
        <div style={{ fontSize:13, color:'rgba(255,255,255,0.35)', marginBottom:28, textAlign:'center', letterSpacing:'0.04em' }}>MANAGEMENT</div>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:14 }}>
          ...
          <button onClick={() => { setItems([]); setSetName(''); setSelectedBand(''); setSelectedShow(''); setRecordId(null); goTo('builder') }}
            ...
            <div style={{ fontSize:13, color:'rgba(255,255,255,0.45)' }}>Start building from scratch</div>
          </button>

          {/* Load setlist */}
          <button onClick={() => goTo('setlists')}
            style={{ width:'100%', padding:'22px 20px', background:'rgba(255,255,255,0.03)', border:'0.5px solid rgba(255,255,255,0.08)', borderRadius:16, cursor:'pointer', textAlign:'left', fontFamily:'inherit', animation:'fadeUp 0.35s ease both' }}>
            <div style={{ fontSize:28, marginBottom:6 }}>📋</div>
            <div style={{ fontSize:17, fontWeight:700, color:'#ffffff', marginBottom:4 }}>My Setlists</div>
            <div style={{ fontSize:13, color:'rgba(255,255,255,0.45)' }}>{setlists.length} saved setlist{setlists.length !== 1 ? 's' : ''}</div>
          </button>

          {/* Song library */}
          <button onClick={() => goTo('songs')}
            style={{ width:'100%', padding:'22px 20px', background:'rgba(255,255,255,0.03)', border:'0.5px solid rgba(255,255,255,0.08)', borderRadius:16, cursor:'pointer', textAlign:'left', fontFamily:'inherit', animation:'fadeUp 0.4s ease both' }}>
            <div style={{ fontSize:28, marginBottom:6 }}>🎵</div>
            <div style={{ fontSize:17, fontWeight:700, color:'#ffffff', marginBottom:4 }}>Song Library</div>
            <div style={{ fontSize:13, color:'rgba(255,255,255,0.45)' }}>{songs.length} songs in your catalog</div>
          </button>
      ...
      <style>{animStyles}</style>
        ...
        <div style={{ padding:'12px 16px', borderBottom:'0.5px solid #1e1e2e', position:'sticky', top:57, background:'#0a0a0f', zIndex:40 }}>
          <input value={songFilter} onChange={e => setSongFilter(e.target.value)} placeholder="Search songs, artists..."
            style={{ width:'100%', padding:'10px 14px', background:'rgba(255,255,255,0.05)', border:'0.5px solid rgba(255,255,255,0.1)', borderRadius:10, color:'#fff', fontSize:14, fontFamily:'inherit', outline:'none', boxSizing:'border-box' }} />
          {/* Tuning chips */}
        ...
        <div style={{ padding:'4px 0 80px' }}>
          <div style={{ padding:'8px 16px', fontSize:11, color:'rgba(255,255,255,0.25)', letterSpacing:'0.06em' }}>{filtered.length} SONGS</div>
          {filtered.map((s,i) => {
            const sf = s.fields
            const tuning = (sf['Guitar Tuning']||'').split('.')[0]
            return (
              <div key={s.id} style={{ display:'flex', alignItems:'center', gap:12, padding:'12px 16px', borderBottom:'0.5px solid rgba(255,255,255,0.04)', animation:'fadeIn 0.2s ease both', animationDelay: Math.min(i*0.015,0.3)+'s' }}>
                {tuning ? <div style={{ width:30, height:30, borderRadius:8, background:'rgba(167,139,250,0.15)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:11, fontWeight:800, color:'#a78bfa', flexShrink:0 }}>{tuning}</div>
                         : <div style={{ width:30, height:30, flexShrink:0 }} />}
                <div style={{ flex:1, minWidth:0 }}>
                  <div style={{ fontSize:14, fontWeight:600, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{sf['Song Title']}</div>
                  <div style={{ fontSize:12, color:'rgba(255,255,255,0.4)', marginTop:2 }}>{sf['Artist']}{sf['Duration'] ? ' · ' + sf['Duration'] : ''}{sf['BPM'] ? ' · ' + sf['BPM'] + ' bpm' : ''}</div>
                </div>
                {sf['Key'] && <div style={{ fontSize:11, color:'rgba(255,255,255,0.3)', flexShrink:0 }}>{sf['Key']}</div>}
              </div>
            )
          })}
        </div>
  ...
  if (screen === 'setlists') return (
    <div key={animKey} style={{ minHeight:'100vh', background:'#0a0a0f', color:'#fff', fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif', ...slideStyle }}>
      ...
      <div style={{ padding:'8px 0 80px' }}>
        {setlists.length === 0 && (
          <div style={{ textAlign:'center', color:'rgba(255,255,255,0.25)', padding:'60px 20px', fontSize:14 }}>No setlists saved yet</div>
        )}
        {setlists.map((sl,i) => {
          const sf = sl.fields
          const bandNames = (sf['Band']||[]).map(id => bands.find(b=>b.id===id)?.fields['Band Name']).filter(Boolean)
          const songCount = (sf['Songs']||[]).length
          const dur = sf['Set Length'] ? Math.floor(sf['Set Length']/60)+'h '+(sf['Set Length']%60)+'m' : ''
          return (
            <div key={sl.id} onClick={() => loadSetlist(sl)}
              style={{ display:'flex', alignItems:'center', gap:14, padding:'16px 16px', borderBottom:'0.5px solid rgba(255,255,255,0.04)', cursor:'pointer', animation:'fadeUp 0.25s ease both', animationDelay: Math.min(i*0.04,0.4)+'s' }}>
              <div style={{ width:44, height:44, borderRadius:12, background:'rgba(167,139,250,0.12)', display:'flex', alignItems:'center', justifyContent:'center', fontSize:20, flexShrink:0 }}>📋</div>
              <div style={{ flex:1, minWidth:0 }}>
                <div style={{ fontSize:15, fontWeight:700, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>{sf['Set Name']||'Untitled'}</div>
                <div style={{ display:'flex', gap:6, marginTop:4, flexWrap:'wrap', alignItems:'center' }}>
                  {bandNames.map((b,bi) => <span key={bi} style={{ fontSize:10, padding:'2px 8px', borderRadius:20, background:BAND_COLORS[b]?.bg||'rgba(167,139,250,0.1)', color:BAND_COLORS[b]?.color||'#a78bfa', fontWeight:600 }}>{b}</span>)}
                  <span style={{ fontSize:11, color:'rgba(255,255,255,0.3)' }}>{songCount} songs{dur ? ' · '+dur : ''}</span>
                </div>
              </div>
  ...
  const pickerFiltered = filterSongs(pickerFilter, '')
  const inSetIds = new Set(items.filter(i=>i.type==='song').map(i=>i.id))

  const blockTypes = [
    { type:'break', label:'Break', icon:'⏸', color:'#6b7280' },
    { type:'tuning', label:'Tuning Change', icon:'🎸', color:'#a78bfa' },
    { type:'merch', label:'Merch', icon:'👕', color:'#f5a623' },
    { type:'instagram', label:'Instagram', icon:'📸', color:'#e1306c' },
    { type:'custom', label:'Custom', icon:'✏️', color:'#7ecbcb' },
  ]
  ...
  return (
    <div key={animKey} style={{ minHeight:'100vh', background:'#0a0a0f', color:'#fff', fontFamily:'-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif', ...slideStyle }}>
      ...
      {/* Header */}
      <div style={{ background:'#0a0a0f', borderBottom:'0.5px solid #1e1e2e', padding:'10px 14px', display:'flex', alignItems:'center', gap:8, position:'sticky', top:0, zIndex:50 }}>
        <button onClick={() => goTo('home','back')} style={{ background:'none', border:'none', color:'#a78bfa', fontSize:22, cursor:'pointer', padding:0 }}>‹</button>
        <input value={setName} onChange={e => setSetName(e.target.value)} placeholder="Set name..."
          style={{ flex:1, background:'transparent', border:'none', color:'#fff', fontSize:15, fontWeight:700, fontFamily:'inherit', outline:'none' }} />
        <div style={{ fontSize:11, color:'rgba(255,255,255,0.3)', whiteSpace:'nowrap' }}>{songCount} · {totalDisplay}</div>
        <button onClick={saveToAirtable} disabled={saving}
          style={{ padding:'7px 14px', background: saved?'rgba(107,203,119,0.2)':'#a78bfa', border:'none', borderRadius:20, color: saved?'#6bcb77':'#000', fontSize:12, fontWeight:700, cursor:'pointer', fontFamily:'inherit', transition:'all 0.2s' }}>
          {saving?'…':saved?'✓':'Save'}
        </button>
        <button onClick={emailSetlist} style={{ padding:'7px 12px', background:'rgba(255,255,255,0.05)', border:'none', borderRadius:20, color:'rgba(255,255,255,0.6)', fontSize:12, cursor:'pointer', fontFamily:'inherit' }}>✉</button>
          ...
          if (item.type === 'song') {
            ...
            return (
              <div key={item.id||idx}
                ...
                style={{ display:'flex', alignItems:'stretch', borderBottom: isOver?'2px solid #a78bfa':'0.5px solid rgba(255,255,255,0.06)', background: isDragging?'rgba(167,139,250,0.1)':'transparent', transition:'background 0.15s' }}>

                {/* Drag handle - full height, wide tap target */}
                <div
                  data-drag-idx={idx}
                  draggable
                  ...
                  style={{ width:52, minHeight:68, display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'center', cursor:'grab', touchAction:'none', userSelect:'none', flexShrink:0, gap:3 }}>
                  <span style={{ fontSize:22, color:'rgba(255,255,255,0.2)', lineHeight:1 }}>⠿</span>
                  <span style={{ fontSize:11, color:'rgba(255,255,255,0.25)', fontWeight:700 }}>{songNum}</span>
                </div>

                {/* Tuning badge */}
                {tuning
                  ? <div style={{ width:38, height:38, borderRadius:10, background:tStyle.bg, display:'flex', alignItems:'center', justifyContent:'center', fontSize:12, fontWeight:800, color:tStyle.color, flexShrink:0, alignSelf:'center' }}>{tuning}</div>
                  : <div style={{ width:38, flexShrink:0 }} />}

                {/* Song info - takes all remaining width */}
                <div style={{ flex:1, minWidth:0, padding:'14px 10px 14px 10px', alignSelf:'center' }}>
                  <div style={{ fontSize:16, fontWeight:600, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap', color:'#fff' }}>{sf['Song Title']}</div>
                ...
                <div style={{ display:'flex', alignItems:'center', paddingRight:4, flexShrink:0 }}>
                  <button onClick={e => { e.stopPropagation(); moveItem(idx,-1) }} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.35)', cursor:'pointer', fontSize:22, width:38, height:68, display:'flex', alignItems:'center', justifyContent:'center' }}>↑</button>
                  <button onClick={e => { e.stopPropagation(); moveItem(idx,1) }} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.35)', cursor:'pointer', fontSize:22, width:38, height:68, display:'flex', alignItems:'center', justifyContent:'center' }}>↓</button>
                  <button onClick={e => { e.stopPropagation(); removeItem(idx) }} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.25)', cursor:'pointer', fontSize:26, width:38, height:68, display:'flex', alignItems:'center', justifyContent:'center' }}>×</button>
                </div>
              </div>
            )
          }
          const blockColors = { break:'rgba(107,114,128,0.1)', tuning:'rgba(167,139,250,0.08)', merch:'rgba(245,166,35,0.08)', instagram:'rgba(225,48,108,0.08)', custom:'rgba(126,203,203,0.08)' }
          const textColors = { break:'#9ca3af', tuning:'#a78bfa', merch:'#f5a623', instagram:'#e1306c', custom:'#7ecbcb' }
          const icons = { break:'⏸', tuning:'🎸', merch:'👕', instagram:'📸', custom:'✏️' }
          return (
            <div key={item.id||idx}
              data-drag-idx={idx}
              onDragOver={e => onDragOver(e,idx)}
              onDrop={e => onDrop(e,idx)}
              style={{ display:'flex', alignItems:'stretch', borderBottom:'0.5px solid rgba(255,255,255,0.06)', background: isDragging?'rgba(167,139,250,0.1)':blockColors[item.type]||'rgba(255,255,255,0.04)', transition:'background 0.15s' }}>
              <div
                data-drag-idx={idx}
                draggable
                onDragStart={e => onDragStart(e,idx)}
                ...
                onTouchMove={onTouchMove}
                onTouchEnd={onTouchEnd}
                style={{ width:52, minHeight:60, display:'flex', alignItems:'center', justifyContent:'center', cursor:'grab', touchAction:'none', userSelect:'none', flexShrink:0 }}>
                <span style={{ fontSize:22, color:'rgba(255,255,255,0.2)' }}>⠿</span>
              </div>
              <span style={{ fontSize:20, alignSelf:'center', marginRight:12, flexShrink:0 }}>{icons[item.type]}</span>
              <span style={{ flex:1, fontSize:16, fontWeight:700, color:textColors[item.type]||'#fff', textTransform: item.type==='custom'||item.type==='tuning'?'none':'uppercase', letterSpacing:'0.05em', alignSelf:'center' }}>{item.text||item.type}</span>
              <div style={{ display:'flex', alignItems:'center', paddingRight:4, flexShrink:0 }}>
                <button onClick={e => { e.stopPropagation(); moveItem(idx,-1) }} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.35)', cursor:'pointer', fontSize:22, width:38, height:60, display:'flex', alignItems:'center', justifyContent:'center' }}>↑</button>
                <button onClick={e => { e.stopPropagation(); moveItem(idx,1) }} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.35)', cursor:'pointer', fontSize:22, width:38, height:60, display:'flex', alignItems:'center', justifyContent:'center' }}>↓</button>
                <button onClick={e => { e.stopPropagation(); removeItem(idx) }} style={{ background:'none', border:'none', color:'rgba(255,255,255,0.25)', cursor:'pointer', fontSize:26, width:38, height:60, display:'flex', alignItems:'center', justifyContent:'center' }}>×</button>
              </div>
            </div>
          )
      ...
      {showSongPicker && (
        <div style={{ position:'fixed', inset:0, zIndex:100, display:'flex', flexDirection:'column', background:'#0a0a0f', animation:'slideInRight 0.25s ease' }}>
          <div style={{ padding:'12px 14px', borderBottom:'0.5px solid #1e1e2e', display:'flex', alignItems:'center', gap:10, background:'#0a0a0f' }}>
            <button onClick={() => setShowSongPicker(false)} style={{ background:'none', border:'none', color:'#a78bfa', fontSize:22, cursor:'pointer', padding:0 }}>✕</button>
            <div style={{ flex:1, fontSize:15, fontWeight:700 }}>Add Songs</div>
            <div style={{ fontSize:12, color:'rgba(255,255,255,0.35)' }}>{pickerFiltered.filter(s=>!inSetIds.has(s.id)).length} available</div>
          </div>
          <div style={{ padding:'10px 14px', borderBottom:'0.5px solid #1e1e2e', background:'#0a0a0f' }}>
            <input autoFocus value={pickerFilter} onChange={e => setPickerFilter(e.target.value)} placeholder="Search..."
              style={{ width:'100%', padding:'10px 14px', background:'rgba(255,255,255,0.06)', border:'0.5px solid rgba(255,255,255,0.1)', borderRadius:10, color:'#fff', fontSize:14, fontFamily:'inherit', outline:'none', boxSizing:'border-box' }} />
          </div>
          <div style={{ flex:1, overflowY:'auto', paddingBottom:40 }}>
            {pickerFiltered.map(s => {
              const sf = s.fields
              const already = inSetIds.has(s.id)
              const tuning = (sf['Guitar Tuning']||'').split('.')[0]
              return (
      ...
      {showBlockPicker && (
        <div onClick={() => setShowBlockPicker(false)} style={{ position:'fixed', inset:0, zIndex:100, background:'rgba(0,0,0,0.7)', display:'flex', alignItems:'flex-end', animation:'fadeIn 0.2s ease' }}>
          <div onClick={e => e.stopPropagation()} style={{ width:'100%', background:'#111118', borderRadius:'20px 20px 0 0', padding:'20px 16px 40px', animation:'slideInLeft 0.25s ease' }}>
            <div style={{ width:36, height:4, background:'rgba(255,255,255,0.15)', borderRadius:2, margin:'0 auto 20px' }} />
            <div style={{ fontSize:14, fontWeight:700, marginBottom:16, color:'rgba(255,255,255,0.5)', letterSpacing:'0.06em', textTransform:'uppercase' }}>Add Block</div>
            <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:10, marginBottom:16 }}>
              {blockTypes.slice(0,4).map(bt => (
                <button key={bt.type} onClick={() => {
                  if (bt.type==='tuning'||bt.type==='custom') return
                  addBlock(bt.type, bt.label)
                  setShowBlockPicker(false)
                }} style={{ padding:'14px 12px', background:'rgba(255,255,255,0.04)', border:'0.5px solid rgba(255,255,255,0.08)', borderRadius:12, cursor:'pointer', fontFamily:'inherit', textAlign:'left' }}>
                  <div style={{ fontSize:22, marginBottom:6 }}>{bt.icon}</div>
                  <div style={{ fontSize:13, fontWeight:600, color: bt.color }}>{bt.label}</div>
                </button>
              ))}
            </div>
            {/* Tuning input */}
            <div style={{ background:'rgba(255,255,255,0.04)', border:'0.5px solid rgba(255,255,255,0.08)', borderRadius:12, padding:'12px', marginBottom:10 }}>
              <div style={{ fontSize:13, fontWeight:600, color:'#a78bfa', marginBottom:8 }}>🎸 Tuning Change</div>
              <div style={{ display:'flex', gap:8 }}>
                <input value={tuningBlockText} onChange={e => setTuningBlockText(e.target.value)} placeholder="e.g. E, D, C, Eb..."
                  style={{ flex:1, padding:'8px 12px', background:'rgba(255,255,255,0.06)', border:'0.5px solid rgba(255,255,255,0.1)', borderRadius:8, color:'#fff', fontSize:13, fontFamily:'inherit', outline:'none' }} />
                <button onClick={() => { if (tuningBlockText.trim()) { addBlock('tuning', tuningBlockText.trim().toUpperCase()); setTuningBlockText(''); setShowBlockPicker(false) } }}
                  style={{ padding:'8px 16px', background:'#a78bfa', border:'none', borderRadius:8, color:'#000', fontSize:13, fontWeight:700, cursor:'pointer', fontFamily:'inherit' }}>Add</button>
              </div>
            </div>
            {/* Custom text input */}
            <div style={{ background:'rgba(255,255,255,0.04)', border:'0.5px solid rgba(255,255,255,0.08)', borderRadius:12, padding:'12px' }}>
              <div style={{ fontSize:13, fontWeight:600, color:'#7ecbcb', marginBottom:8 }}>✏️ Custom</div>
              <div style={{ display:'flex', gap:8 }}>
                <input value={customBlockText} onChange={e => setCustomBlockText(e.target.value)} placeholder="Custom callout text..."
                  style={{ flex:1, padding:'8px 12px', background:'rgba(255,255,255,0.06)', border:'0.5px solid rgba(255,255,255,0.1)', borderRadius:8, color:'#fff', fontSize:13, fontFamily:'inherit', outline:'none' }} />
                <button onClick={() => { if (customBlockText.trim()) { addBlock('custom', customBlockText.trim()); setCustomBlockText(''); setShowBlockPicker(false) } }}
                  style={{ padding:'8px 16px', background:'#7ecbcb', border:'none', borderRadius:8, color:'#000', fontSize:13, fontWeight:700, cursor:'pointer', fontFamily:'inherit' }}>Add</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div style={{ padding:'20px', maxWidth:520, margin:'0 auto' }}>
        {done ? (
          <div style={{ textAlign:'center', padding:'4rem 0' }}>
            ...
            <button onClick={onBack} style={{ padding:'12px 28px', background:'#1a1a2e', border:'none', borderRadius:10, color:'#a78bfa', fontSize:14, fontWeight:600, cursor:'pointer', fontFamily:'inherit' }}>Back to home</button>
          </div>
        ) : (
          <>
            <div style={{ marginBottom:20 }}>
            ...
            <button onClick={submit} disabled={submitting} style={{ width:'100%', padding:'14px', background:'#1a1a2e', border:'none', borderRadius:10, color:'#a78bfa', fontSize:15, fontWeight:700, cursor:'pointer', fontFamily:'inherit', opacity: submitting ? 0.7 : 1 }}>
